...
simulate.schedules = ifelse(currentWeek==10,1,0)
...
if (simulate.schedules == 1) {
  ...
  saveRDS(all.sched, "C:/Users/lvwilson/Desktop/fantasy/allsched.rds")
} else {
  all.sched <- readRDS("C:/Users/lvwilson/Desktop/fantasy/allsched.rds")
}

all.sched <- all.sched %>% filter(week <= currentWeek)
